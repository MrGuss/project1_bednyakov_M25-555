ROOMS = {
    ...
    'hall': {
        ...
        'items': [],
        'puzzle': ('На пьедестале надпись: "Назовите число, что идет после девяти". Введите ответ цифрой или словом.',
                   ('10', 'десять'), 'Сокровище1')
    },
    'trap_room': {
    ...
    'treasure_room': {
          ...
          'puzzle': ('Дверь защищена кодом. Введите код (подсказка: это число пятикратного шага, 2*5= ? )',
                     ('10', 'десять'))
    }
}
